...
- baseline peak 折均 **0.00167346** → history **0.00186730**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.938e-04 | **+11.58%** | 3/3 | +9.89% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.392e-04 | +9.80% | 3/3 | +8.68% | 0.250 |

- 逐折 Δpeak：['+1.623e-04', '+2.504e-04', '+1.689e-04']
- ΔA +7.86%，ΔB +4.31%，`2ΔA > ΔB` 成立
