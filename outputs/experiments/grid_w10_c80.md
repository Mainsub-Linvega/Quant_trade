...
- 特征 200 列 + history 80 列 × 4 块，窗长 10
...
- baseline peak 折均 **0.00171327** → history **0.00189323**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.800e-04 | **+10.50%** | 3/3 | +8.83% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.210e-04 | +8.40% | 3/3 | +7.49% | 0.250 |

- 逐折 Δpeak：['+9.472e-05', '+2.374e-04', '+2.078e-04']
- ΔA +6.69%，ΔB +3.28%，`2ΔA > ΔB` 成立
