...
- baseline peak 折均 **0.00171327** → history **0.00188096**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.677e-04 | **+9.79%** | 3/3 | +9.13% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.126e-04 | +7.81% | 3/3 | +7.60% | 0.250 |

- 逐折 Δpeak：['+1.339e-04', '+1.901e-04', '+1.791e-04']
- ΔA +5.86%，ΔB +1.98%，`2ΔA > ΔB` 成立
