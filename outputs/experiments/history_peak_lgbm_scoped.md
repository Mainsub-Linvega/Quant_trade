...
- baseline peak 折均 **0.00177542** → history **0.00195473**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.793e-04 | **+10.10%** | 5/5 | +9.10% | 0.062 |
| 固定 scale 0.5（旧口径） | +1.214e-04 | +8.32% | 5/5 | +7.68% | 0.062 |

- 逐折 Δpeak：['+1.189e-04', '+1.548e-04', '+1.638e-04', '+2.086e-04', '+2.506e-04']
- ΔA +6.67%，ΔB +2.87%，`2ΔA > ΔB` 成立
