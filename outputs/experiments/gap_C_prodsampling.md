...
- 折 3 × train_window 39,480，embargo 6，sample_modulo 5
...
- baseline peak 折均 **0.00078002** → history **0.00094161**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.616e-04 | **+20.72%** | 3/3 | +18.48% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.369e-04 | +18.12% | 3/3 | +16.76% | 0.250 |

- 逐折 Δpeak：['+1.461e-04', '+1.421e-04', '+1.965e-04']
- ΔA +11.65%，ΔB +3.37%，`2ΔA > ΔB` 成立
