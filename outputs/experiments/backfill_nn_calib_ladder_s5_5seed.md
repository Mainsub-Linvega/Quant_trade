# Backfill NN holdout (backfill_nn_calib_ladder_s5_5seed)
...
Arms: both; seeds: 2026, 2027, 2028, 2029, 2030; responders: responder_00, responder_02, responder_03, responder_04, responder_05; aux lambda=0.3.
Artifacts: `outputs/experiments/backfill_nn_calib_ladder_s5_5seed_artifacts`; replay max abs=9.708e-08; cold-start max abs=9.708e-08.
...
| `aux_ladder` | 0.00181214 | 0.5768 | 0.00083651 | +3.1418e-03 | 5.4471e-03 |

Aux delta vs target-only: -4.112e-05 (-2.22%).
