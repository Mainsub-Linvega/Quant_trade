...
- 特征 200 列 + history 80 列 × 4 块，窗长 5
...
- baseline peak 折均 **0.00171327** → history **0.00193672**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +2.235e-04 | **+13.04%** | 3/3 | +10.72% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.430e-04 | +9.93% | 3/3 | +8.63% | 0.250 |

- 逐折 Δpeak：['+1.017e-04', '+3.032e-04', '+2.655e-04']
- ΔA +7.65%，ΔB +2.96%，`2ΔA > ΔB` 成立
