...
- 特征 200 列 + history 40 列 × 4 块，窗长 20
...
- baseline peak 折均 **0.00171327** → history **0.00182513**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.119e-04 | **+6.53%** | 3/3 | +5.43% | 0.250 |
| 固定 scale 0.5（旧口径） | +7.929e-05 | +5.50% | 3/3 | +4.91% | 0.250 |

- 逐折 Δpeak：['+8.457e-05', '+1.016e-04', '+1.494e-04']
- ΔA +4.39%，ΔB +2.14%，`2ΔA > ΔB` 成立
