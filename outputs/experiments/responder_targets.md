...
|---:|---|---:|---:|---:|
| 0 | `responder_29` | 0.00201702 | 0.00224996 (+11.55%) | 0.00200966 (-0.37%) |
| 1 | `responder_29` | 0.00387559 | 0.00345392 (-10.88%) | 0.00326875 (-15.66%) |
| 2 | `target` | 0.00092161 | 0.00092161 (+0.00%) | 0.00080729 (-12.40%) |
| 3 | `responder_04` | 0.00136105 | 0.00125835 (-7.55%) | 0.00102004 (-25.06%) |
| 4 | `target` | 0.00222091 | 0.00222091 (+0.00%) | 0.00290960 (+31.01%) |

## inner_selected 臂

- baseline 折均 **0.00207924** → 本臂 **0.00202095**
- 配对 Δ 均值 -5.828e-05（**-2.80%**），1/5 折为正，符号检验 p=0.375
- 去掉最好一折：-6.30%
- 整条 alpha 阶梯为正：❌

## multi 臂

- baseline 折均 **0.00207924** → 本臂 **0.00200307**
- 配对 Δ 均值 -7.617e-05（**-3.66%**），1/5 折为正，符号检验 p=0.375
- 去掉最好一折：-12.86%
- 整条 alpha 阶梯为正：❌
