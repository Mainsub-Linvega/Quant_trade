...
- baseline peak 折均 **0.00174926** → history **0.00189179**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.425e-04 | **+8.15%** | 3/3 | +7.16% | 0.250 |
| 固定 scale 0.5（旧口径） | +9.675e-05 | +6.67% | 3/3 | +6.20% | 0.250 |

- 逐折 Δpeak：['+1.157e-04', '+1.347e-04', '+1.773e-04']
- ΔA +5.20%，ΔB +2.08%，`2ΔA > ΔB` 成立
