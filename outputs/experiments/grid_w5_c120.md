...
- 特征 200 列 + history 120 列 × 4 块，窗长 5
...
- baseline peak 折均 **0.00171327** → history **0.00190212**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.889e-04 | **+11.02%** | 3/3 | +8.43% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.222e-04 | +8.48% | 3/3 | +7.20% | 0.250 |

- 逐折 Δpeak：['+1.051e-04', '+2.777e-04', '+1.838e-04']
- ΔA +6.53%，ΔB +2.59%，`2ΔA > ΔB` 成立
