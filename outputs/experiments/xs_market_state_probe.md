# 截面块市场态交互探针（`xs_market_state_probe`）
...
|--:|--:|--:|--:|--:|:--:|--:|--:|:--:|
| **+0.77%** | 3/5 | -0.23% | +2.46% | +3.02% | ✅ | -1.43% | 6.1% | ❌ |
...
| 1 | +0.05838 | +0.05439 | +0.05309 | -2.37% |
| 2 | +0.05861 | +0.05493 | +0.05419 | -1.35% |
| 3 | +0.04975 | +0.04632 | +0.04871 | +5.16% |
| 4 | +0.04473 | +0.04313 | +0.04393 | +1.85% |
