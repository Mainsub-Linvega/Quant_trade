...
- baseline peak 折均 **0.00171327** → history **0.00164937**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | -6.390e-05 | **-3.73%** | 0/3 | -5.21% | 0.250 |
| 固定 scale 0.5（旧口径） | -4.328e-05 | -3.00% | 0/3 | -3.81% | 0.250 |

- 逐折 Δpeak：['-3.354e-05', '-1.451e-04', '-1.307e-05']
- ΔA -2.45%，ΔB -1.51%，`2ΔA > ΔB` **不成立**
