...
- 特征 200 列 + history 160 列 × 4 块，窗长 5
...
- baseline peak 折均 **0.00171327** → history **0.00187535**

| 口径 | 配对 Δ 均值 | 相对 | 正折 | 去掉最好一折 | 符号检验 p |
|---|---:|---:|---:|---:|---:|
| **peak（判据口径）** | +1.621e-04 | **+9.46%** | 3/3 | +7.84% | 0.250 |
| 固定 scale 0.5（旧口径） | +1.096e-04 | +7.61% | 3/3 | +6.98% | 0.250 |

- 逐折 Δpeak：['+1.289e-04', '+2.176e-04', '+1.398e-04']
- ΔA +5.86%，ΔB +2.41%，`2ΔA > ΔB` 成立
