...
- 公榜 **0.00187232**（8/08 提交，严格求解器模型 `c23a8cfb`，200 特征 / alpha 2e6 / scale 1.13）；
  同 scale 下 legacy `e2bec9a9` 是 0.00186805。公榜第一 0.00520002
- ⚠️ scale=1.13 是公榜抛物线顶点，**对公榜测试集拟合**，私榜交付前须重估（本地给 0.88~0.97）
